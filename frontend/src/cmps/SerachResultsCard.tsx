...
export const SerachResultsCard = ({ hotel }: Props) => {
    return (
            ...
            <div className="grid grid-rows-[1fr_2fr_1fr] ">
                ...
                <div className="grid grid-cols-2 items-end whitespace-nowrap">
                    ...
                    <div className="flex flex-col items-end gap-1">
                        ...
                        <Link to={`/detail/${hotel._id}`} className="rounded bg-blue-600 text-white h-full p-2 font-bold text-xl max-w-fit hover:bg-blue-500">View More</Link>
                    </div>
                </div>
            </div>
        </div>
