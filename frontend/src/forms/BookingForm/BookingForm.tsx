    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-2 gap-6">
                <label className="text-gray-700 text-sm from-blue-500 flex-1">
                    First Name
                    <input
            ...
            <div className="flex justify-end">
                <button
                    disabled={isLoading}
                    type="submit"
                    className="rounded bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-md disabled:bg-gray-500"
                >
